...
df = pd.read_csv('GGXY.csv') # can change this file but i think this is the best we have
...
threshold = 0.98 * max_y  # can change threshold
...
# limit to at most 2 optimal ranges
...
# 3 clusters, launch angle and face to path
...
label_map = { # low is fat, high is thin
